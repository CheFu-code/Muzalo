  ...
  return (
    <div className="min-h-screen">
      <section className="border-b border-white/10 bg-gray-950">
        <div className="mx-auto grid max-w-7xl gap-6 px-4 py-8 sm:gap-8 sm:px-6 sm:py-12 lg:grid-cols-[0.9fr_1.1fr]">
          ...
          <div className="rounded-2xl border border-white/10 bg-gray-800/40 p-3 shadow-2xl shadow-black/30 sm:rounded-3xl">
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 sm:py-12">
        <div className="grid grid-cols-1 gap-4 sm:gap-6 md:grid-cols-2">
          <div className="rounded-2xl border border-white/10 bg-gray-800/40 p-4 sm:p-6">
